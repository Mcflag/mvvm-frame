 ...
 */
public class SettingMainHandler extends Handler {
     ...
     * 真正负责扫描任务的核心线程
     */
    private final SettingDecodeThread decodeThread;

    private State state;

    private final CameraManager cameraManager;

    public SettingMainHandler(SettingsActivity activity, CameraManager cameraManager) {
        this.activity = activity;
        // 启动扫描线程
        decodeThread = new SettingDecodeThread(activity);
        decodeThread.start();
        state = State.SUCCESS;
