...
final class SettingDecodeHandler extends Handler {

    private static final String TAG = SettingDecodeHandler.class.getSimpleName();
    ...
    SettingDecodeHandler(SettingsActivity activity) {
